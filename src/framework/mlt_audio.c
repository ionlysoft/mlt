...
MLTPP_DECLSPEC int mlt_audio_calculate_frame_samples( float fps, int frequency, int64_t position )
{
...
MLTPP_DECLSPEC int mlt_audio_format_size( mlt_audio_format format, int samples, int channels )
{
	switch ( format )
	{
		case mlt_audio_none:   return 0;
