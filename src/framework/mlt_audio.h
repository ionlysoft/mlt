...
extern MLTPP_DECLSPEC int mlt_audio_calculate_frame_samples( float fps, int frequency, int64_t position );
extern MLTPP_DECLSPEC int mlt_audio_format_size( mlt_audio_format format, int samples, int channels );
#if defined(__cplusplus)
}
#endif
#endif
