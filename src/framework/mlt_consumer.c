...
MLTPP_DECLSPEC int mlt_consumer_connect( mlt_consumer self, mlt_service producer )
{
...
MLTPP_DECLSPEC int mlt_consumer_start( mlt_consumer self )
{
	if (!self) {
		return 1;
	}
...
MLTPP_DECLSPEC void mlt_consumer_purge( mlt_consumer self )
{
	if ( self )
	{
		consumer_private *priv = self->local;
...
MLTPP_DECLSPEC int mlt_consumer_stop( mlt_consumer self )
{
	if (!self) {
		return 1;
	}
...
MLTPP_DECLSPEC int mlt_consumer_is_stopped( mlt_consumer self )
{
...
MLTPP_DECLSPEC void mlt_consumer_close( mlt_consumer self )
{
...
MLTPP_DECLSPEC mlt_position mlt_consumer_position( mlt_consumer consumer )
{
	consumer_private* priv = consumer->local;
	pthread_mutex_lock( &priv->position_mutex );
