...
extern "C" {
#endif
extern MLTPP_DECLSPEC int mlt_consumer_connect( mlt_consumer self, mlt_service producer );
extern MLTPP_DECLSPEC int mlt_consumer_start( mlt_consumer self );
extern MLTPP_DECLSPEC void mlt_consumer_purge( mlt_consumer self );
extern MLTPP_DECLSPEC int mlt_consumer_stop( mlt_consumer self );
extern MLTPP_DECLSPEC int mlt_consumer_is_stopped( mlt_consumer self );
extern MLTPP_DECLSPEC void mlt_consumer_close( mlt_consumer );
extern MLTPP_DECLSPEC mlt_position mlt_consumer_position( mlt_consumer );
#if defined(__cplusplus)
}
#endif
