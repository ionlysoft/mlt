...
MLTPP_DECLSPEC int mlt_events_fire(mlt_properties self, const char *id, mlt_event_data event_data)
{
	int result = 0;
	mlt_events events = mlt_events_fetch( self );
	if ( events != NULL )
...
MLTPP_DECLSPEC mlt_event mlt_events_listen( mlt_properties self, void *listener_data, const char *id, mlt_listener listener )
{
...
MLTPP_DECLSPEC mlt_event_data mlt_event_data_none()
{
...
MLTPP_DECLSPEC mlt_event_data mlt_event_data_from_int(int value)
{
	mlt_event_data event_data;
...
MLTPP_DECLSPEC int mlt_event_data_to_int(mlt_event_data event_data)
{
