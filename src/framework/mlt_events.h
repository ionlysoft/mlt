...
extern MLTPP_DECLSPEC int mlt_events_fire( mlt_properties self, const char *id, mlt_event_data );
extern MLTPP_DECLSPEC mlt_event mlt_events_listen( mlt_properties self, void *listener_data, const char *id, mlt_listener listener );
extern MLTPP_DECLSPEC mlt_event_data mlt_event_data_none();
extern MLTPP_DECLSPEC mlt_event_data mlt_event_data_from_int(int value);
extern MLTPP_DECLSPEC int mlt_event_data_to_int(mlt_event_data);
