...
extern "C" {
#endif
extern MLTPP_DECLSPEC mlt_repository mlt_factory_init( const char *directory );
extern MLTPP_DECLSPEC mlt_producer mlt_factory_producer( mlt_profile profile, const char *service, const void *resource );
extern MLTPP_DECLSPEC mlt_filter mlt_factory_filter( mlt_profile profile, const char *name, const void *input );
extern MLTPP_DECLSPEC mlt_consumer mlt_factory_consumer( mlt_profile profile, const char *name, const void *input );
extern MLTPP_DECLSPEC void mlt_factory_close( );
#if defined(__cplusplus)
}
#endif
