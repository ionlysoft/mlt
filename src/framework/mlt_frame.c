...
MLTPP_DECLSPEC mlt_frame mlt_frame_init( mlt_service service )
{
	// Allocate a frame
...
MLTPP_DECLSPEC mlt_position mlt_frame_get_position( mlt_frame self )
{
...
MLTPP_DECLSPEC void mlt_frame_close( mlt_frame self )
{
...
MLTPP_DECLSPEC mlt_frame mlt_frame_clone( mlt_frame self, int is_deep )
{
