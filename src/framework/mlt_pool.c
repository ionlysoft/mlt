...
MLTPP_DECLSPEC void *mlt_pool_alloc( int size )
{
...
MLTPP_DECLSPEC void mlt_pool_purge( )
{
	int i = 0;
...
MLTPP_DECLSPEC void mlt_pool_release( void *release )
{
	// Return to the pool
	pool_return( release );
}
...
MLTPP_DECLSPEC void mlt_pool_close( )
{
