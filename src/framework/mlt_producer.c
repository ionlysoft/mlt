...
MLTPP_DECLSPEC int mlt_producer_seek( mlt_producer self, mlt_position position )
{
	if ( self->seek )
	{
...
MLTPP_DECLSPEC mlt_position mlt_producer_position( mlt_producer self )
{
...
MLTPP_DECLSPEC int mlt_producer_set_speed( mlt_producer self, double speed )
{
...
MLTPP_DECLSPEC double mlt_producer_get_speed( mlt_producer self )
{
...
MLTPP_DECLSPEC double mlt_producer_get_fps( mlt_producer self )
{
...
MLTPP_DECLSPEC int mlt_producer_set_in_and_out( mlt_producer self, mlt_position in, mlt_position out )
{
...
MLTPP_DECLSPEC mlt_position mlt_producer_get_playtime( mlt_producer self )
{
...
MLTPP_DECLSPEC mlt_position mlt_producer_get_length( mlt_producer self )
{
...
MLTPP_DECLSPEC void mlt_producer_close( mlt_producer self )
{
