...
extern "C" {
#endif
extern MLTPP_DECLSPEC mlt_profile mlt_profile_init( const char *name );
extern MLTPP_DECLSPEC void mlt_profile_close( mlt_profile profile );
extern MLTPP_DECLSPEC mlt_profile mlt_profile_clone( mlt_profile profile );
extern MLTPP_DECLSPEC mlt_properties mlt_profile_list( );
extern MLTPP_DECLSPEC void mlt_profile_from_producer( mlt_profile profile, mlt_producer producer );
#if defined(__cplusplus)
}
#endif
