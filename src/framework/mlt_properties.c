...
MLTPP_DECLSPEC mlt_properties mlt_properties_new( )
{
...
MLTPP_DECLSPEC int mlt_properties_inc_ref( mlt_properties self )
{
	int result = 0;
	if ( self != NULL )
	{
...
MLTPP_DECLSPEC int mlt_properties_inherit( mlt_properties self, mlt_properties that )
{
...
MLTPP_DECLSPEC int mlt_properties_set( mlt_properties self, const char *name, const char *value )
{
	int error = 1;
...
MLTPP_DECLSPEC char *mlt_properties_get_name( mlt_properties self, int index )
{
	if ( !self ) return NULL;
	property_list *list = self->local;
...
MLTPP_DECLSPEC char *mlt_properties_get_value( mlt_properties self, int index )
{
...
MLTPP_DECLSPEC int mlt_properties_count( mlt_properties self )
{
	if ( !self ) return -1;
	property_list *list = self->local;
	return list->count;
...
MLTPP_DECLSPEC int mlt_properties_parse( mlt_properties self, const char *namevalue )
{
	if ( !self ) return 1;
...
MLTPP_DECLSPEC int mlt_properties_get_int( mlt_properties self, const char *name )
{
	int result = 0;
	mlt_property value = mlt_properties_find( self, name );
	if ( value )
...
MLTPP_DECLSPEC int mlt_properties_set_int( mlt_properties self, const char *name, int value )
{
	int error = 1;
...
MLTPP_DECLSPEC double mlt_properties_get_double( mlt_properties self, const char *name )
{
	double result = 0;
	mlt_property value = mlt_properties_find( self, name );
	if ( value )
...
MLTPP_DECLSPEC void *mlt_properties_get_data( mlt_properties self, const char *name, int *length )
{
	mlt_property value = mlt_properties_find( self, name );
...
MLTPP_DECLSPEC int mlt_properties_set_data( mlt_properties self, const char *name, void *value, int length, mlt_destructor destroy, mlt_serialiser serialise )
{
	int error = 1;
...
MLTPP_DECLSPEC void mlt_properties_close( mlt_properties self )
{
...
MLTPP_DECLSPEC char *mlt_properties_serialise_yaml( mlt_properties self )
{
	if ( !self ) return NULL;
