...
extern "C" {
#endif
extern MLTPP_DECLSPEC mlt_properties mlt_properties_new( );
extern MLTPP_DECLSPEC int mlt_properties_inc_ref( mlt_properties self );
extern MLTPP_DECLSPEC int mlt_properties_inherit( mlt_properties self, mlt_properties that );
extern MLTPP_DECLSPEC int mlt_properties_set( mlt_properties self, const char *name, const char *value );
extern MLTPP_DECLSPEC int mlt_properties_parse( mlt_properties self, const char *namevalue );
extern MLTPP_DECLSPEC char *mlt_properties_get_name( mlt_properties self, int index );
extern MLTPP_DECLSPEC char *mlt_properties_get_value( mlt_properties self, int index );
extern MLTPP_DECLSPEC int mlt_properties_get_int( mlt_properties self, const char *name );
extern MLTPP_DECLSPEC int mlt_properties_set_int( mlt_properties self, const char *name, int value );
extern MLTPP_DECLSPEC double mlt_properties_get_double( mlt_properties self, const char *name );
extern MLTPP_DECLSPEC int mlt_properties_set_data( mlt_properties self, const char *name, void *value, int length, mlt_destructor, mlt_serialiser );
extern MLTPP_DECLSPEC void *mlt_properties_get_data( mlt_properties self, const char *name, int *length );
extern MLTPP_DECLSPEC int mlt_properties_count( mlt_properties self );
extern MLTPP_DECLSPEC void mlt_properties_close( mlt_properties self );
extern MLTPP_DECLSPEC char *mlt_properties_serialise_yaml( mlt_properties self );
#if defined(__cplusplus)
}
#endif
