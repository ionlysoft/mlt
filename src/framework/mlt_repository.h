...
extern "C" {
#endif
extern MLTPP_DECLSPEC mlt_properties mlt_repository_consumers( mlt_repository self );
extern MLTPP_DECLSPEC mlt_properties mlt_repository_filters( mlt_repository self );
extern MLTPP_DECLSPEC mlt_properties mlt_repository_producers( mlt_repository self );
extern MLTPP_DECLSPEC mlt_properties mlt_repository_transitions( mlt_repository self );
extern MLTPP_DECLSPEC mlt_properties mlt_repository_metadata( mlt_repository self, mlt_service_type type, const char *service );
extern MLTPP_DECLSPEC mlt_properties mlt_repository_presets( );
