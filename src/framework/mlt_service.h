...
extern "C" {
#endif
extern MLTPP_DECLSPEC mlt_service mlt_service_consumer( mlt_service self );
extern MLTPP_DECLSPEC int mlt_service_attach( mlt_service self, mlt_filter filter );
extern MLTPP_DECLSPEC void mlt_service_cache_set_size( mlt_service self, const char *name, int size );
#if defined(__cplusplus)
}
#endif
