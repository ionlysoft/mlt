...
extern mlt_filter filter_transpose_init( mlt_profile profile, mlt_service_type type, const char *id, char *arg );
...
extern mlt_filter filter_watermark_affine_init( mlt_profile profile, mlt_service_type type, const char *id, char *arg );
extern mlt_filter filter_watermark_audio_init( mlt_profile profile, mlt_service_type type, const char *id, char *arg );
...
void mlt_register_core( mlt_repository repository )
{
    ...
    MLT_REGISTER( mlt_service_filter_type, "transpose", filter_transpose_init );
    ...
    MLT_REGISTER( mlt_service_filter_type, "watermark_affine", filter_watermark_affine_init );
    ...
    MLT_REGISTER_METADATA( mlt_service_filter_type, "transpose", metadata, "filter_transpose.yml" );
    ...
    MLT_REGISTER_METADATA( mlt_service_filter_type, "watermark_affine", metadata, "filter_watermark_affine.yml" );
