...
extern mlt_producer producer_qwebp_init( mlt_profile profile, mlt_service_type type, const char *id, char *arg );
...
void mlt_register_qt(mlt_repository repository)
{
#ifdef USE_QT_OPENGL
    ...
    MLT_REGISTER( mlt_service_producer_type, "qwebp", producer_qwebp_init );
    ...
    MLT_REGISTER_METADATA( mlt_service_producer_type, "qwebp", metadata, "producer_qwebp.yml" );
