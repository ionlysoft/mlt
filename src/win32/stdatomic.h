                                                 ...
                                                 intptr_t desired)
{
   ...
   // *expected = OSAtomicCompareAndSwap64Barrier ((int64_t) (object), (int64_t) (desired), (int64_t*) (old));
    *expected = OSAtomicCompareAndSwap64Barrier ((int64_t) (old), (int64_t) (desired), (int64_t*) (object));
    return *expected == old;
}
#endif
